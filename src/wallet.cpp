...
// TitanCoin: total coins staked (non-spendable until maturity)
...
// TitanCoin: get current stake weight
...
// TitanCoin: check 'spent' consistency between wallet and txindex
// TitanCoin: fix wallet spent state according to txindex
...
// TitanCoin: disable transaction (only for coinstake)
